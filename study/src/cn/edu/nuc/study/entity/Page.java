...
public class Page {
	...
	public String toString() {
		return "Page [currentPage=" + currentPage + ", currentResult="
				+ currentResult + ", entityOrField=" + entityOrField
				+ ", pageStr=" + pageStr + ", showCount=" + showCount
				+ ", totalPage=" + totalPage + ", totalResult=" + totalResult
				+ "]";
	}
